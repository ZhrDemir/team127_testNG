...
public class ReusableMethods {
    ...
    public static void tumSayfaTakeScreenshot(WebDriver driver){
        ...
        String dinamikDosyaYolu = "target/screenshots/tumSayfaScreenshot"+ ldt.format(istenenFormat)+".jpg";
    ...
    public static void istenenWebElementScreenshot(WebElement istenenWebElement){
        ...
        File geciciDoya = istenenWebElement.getScreenshotAs(OutputType.FILE);

        try {
            FileUtils.copyFile(geciciDoya,istenenWebElementScreenshot);
        } catch (IOException e) {
